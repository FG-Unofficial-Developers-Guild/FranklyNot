...
--
-- luacheck: globals onInit onClose isFranklyNot onShowLongOptionChange onValueChanged isLong makeDefault
-- luacheck: globals makeShort makeLong onGainFocus onLoseFocus
function onInit()
